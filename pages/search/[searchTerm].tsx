  ...
  return (
    <div className="w-full  ">
      ...
      {isAccounts ? (
          ...
          {searchedAccounts.length > 0 ? (
            searchedAccounts.map((user: IUser, index: number) => (
              <Link key={index} href={`/profile/${user._id}`}>
                <div className=" flex gap-3 pt-20 p-2 cursor-pointer font-semibold rounded border-b-2 border-gray-200">
                  <div>
                    <Image
                      width={50}
                      height={50}
        ...
        <div className="mt-16 pt-16 flex flex-wrap gap-6 md:justify-start ">
          {videos.length ? (
